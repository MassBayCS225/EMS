...
public class TestGuiDriver 
{
    public static void main(String[] args) throws PasswordMismatchError, IllegalCharacterException, PrivilegeInsufficientException, DoesNotExistException
    {
        ...
        c.setChair(new User(1,"A","B","AB@AB.com","ab","ab"));
         ...
         SubEvent se1 = new SubEvent(1,1,"SE Test 1");
        ...
        SubEvent se2 = new SubEvent(1,2,"SE Test 2");
        ...
        SubEvent se3 = new SubEvent(1,3,"SE Test 3");
        ...
        SubEvent se4 = new SubEvent(1,4,"SE Test 4");
        ...
        SubEvent se5 = new SubEvent(1,5,"SE Test 5");
        ...
        SubEvent se6 = new SubEvent(1,6,"SE Test 6");
